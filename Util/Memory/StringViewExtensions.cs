namespace BetterRouletteBase.Util.Memory;
...
internal static class StringViewExtensions
{
    ...
    public static bool Equals(this string self, StringView value, StringComparison comparisonType)
    {
        return self.AsSpan().Equals(value.AsSpan(), comparisonType);
    }
}
